    ...
    if (vertical) {
        ...
        return (
            <div className={`relative ${className}`}>
                <div className="absolute top-0 left-0 text-transparent font-bebas text-[9rem] font-bold stroke-text-white opacity-30 transform -translate-x-1 -translate-y-10">
                    {text.repeat(repeat)}
                </div>
            </div>
        )
